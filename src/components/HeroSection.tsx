...
function HeroSection() {
  return (
    <div
    className="h-auto bg-gradient-to-b from-black to-gray-900 md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0"
    >
        <Spotlight
