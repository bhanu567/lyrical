  ...
  const googleOAuthURL = `https://accounts.google.com/o/oauth2/v2/auth?${QueryString.stringify(
    {
      ...
      redirect_uri: `${process.env.DOMAIN!}/api/users/auth/redirect-google`, // This is the uri that will be redirected to if the user signs into his google account successfully
